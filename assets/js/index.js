$(function() {
  ...
  const PARENT_FACE_Y = '45px' // Distance of face hole from top. Gross.
  const PARENT_FACE_HEIGHT = '250px' // The height of the face hole. Gross.
  const PARENT_FACE_WIDTH = 178; // The width of the face hole. Gross.
